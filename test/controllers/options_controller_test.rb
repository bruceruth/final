...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { appointment_id: @option.appointment_id, discount: @option.discount, pricePerPerson: @option.pricePerPerson }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { appointment_id: @option.appointment_id, discount: @option.discount, pricePerPerson: @option.pricePerPerson }
    assert_redirected_to option_path(assigns(:option))
  end
